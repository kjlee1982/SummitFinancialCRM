            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500 font-medium">
                        Managing ${contacts.length} professional relationships across your markets.
                    </p>
                </div>
                <button data-action="contact-add" class="bg-slate-900 text-white px-5 py-2.5 rounded-lg hover:bg-slate-800 font-bold shadow-sm transition-all flex items-center text-sm">
...
function renderContactCards(contacts) {
    ...
    return contacts.map(contact => {
        const categoryClass = getCategoryClass(contact.category);
                ...
                <div class="p-5">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div class="flex gap-2">
                             <button data-action="contact-edit" data-id="${contact.id}" class="text-gray-300 hover:text-slate-600 transition-colors">
                                <i class="fa fa-pen text-xs"></i>
                            </button>
                            <button data-action="contact-delete" data-id="${contact.id}" class="text-gray-300 hover:text-red-500 transition-colors">
                    ...
                    <div class="text-center mb-4">
                        <div class="w-16 h-16 rounded-full bg-orange-50 text-orange-600 flex items-center justify-center text-xl font-bold mx-auto mb-2">
                    ...
                    <div class="space-y-2 pt-4 border-t border-gray-50">
                        ...
                        <div class="flex items-center text-sm text-gray-600">
                            ...
                            <span>${contact.phone ? formatters.phone(contact.phone) : 'No phone'}</span>
                        </div>
                    </div>
                </div>
...
export function showAddContactModal() {
    const formHtml = `
        <div class="grid grid-cols-2 gap-4">
            <div class="col-span-2">
                ...
                <input type="text" id="name" class="w-full p-3 border rounded-lg" placeholder="e.g. Sarah Jenkins">
            </div>
            <div class="col-span-2">
                <label class="block text-xs font-bold text-gray-400 uppercase mb-1">Company / Firm</label>
                <input type="text" id="company" class="w-full p-3 border rounded-lg" placeholder="e.g. CBRE or Chase Bank">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="tel" id="phone" class="w-full p-3 border rounded-lg" placeholder="555-0123">
            </div>
            <div class="col-span-2">
    ...
    modalManager.show("Add New Contact", formHtml, (data) => {
        stateManager.add('contacts', data);
    });
}
