...
export const authModule = {
    ...
    init() {
        onAuthStateChanged(auth, async (user) => {
            ...
            if (user) {
                ...
                // Redirect to dashboard if on landing/login
    ...
    setupListeners(overlay) {
        ...
        toggleBtn.onclick = () => {
            ...
            this.setupListeners(overlay); // Re-bind listeners to new HTML
        };
        ...
        form.onsubmit = async (e) => {
            ...
            try {
                ...
                // No need to remove overlay here, onAuthStateChanged will handle it
            } catch (error) {
